...
requirements = python3,kivy==2.2.1,kivymd==1.2.0,pillow==10.0.1
...
# (str) Path to your iOS developer identity (usually you won't need to change this)
...
# (str) Team identifier (tvos.development_team)
#tvos.development_team = <hex string>

# (str) TVOS deployment target
#tvos.deployment_target = 9.0

# (bool) Indicate if the application should be fullscreen or not
#tvos.fullscreen = 1

# (bool) Indicate that the application should support the background audio mode.  This is used by the
# audio and video playback features.  It enables the audio session to be set to allow background
# audio playback, such as from the iPod app.
#tvos.background_audio = 0
