...
class CustomButton(Button):
    """
    Custom button with enhanced styling and demonic theme.
    """
    
    def __init__(self, **kwargs):
        # Set default properties for demonic theme
...
class CombatLog(Label):
    """
    Custom label for displaying combat log messages.
    """
    
    def __init__(self, **kwargs):
        super().__init__(**kwargs)
        self.text = "Combat begins..."
        self.font_size = '14sp'
