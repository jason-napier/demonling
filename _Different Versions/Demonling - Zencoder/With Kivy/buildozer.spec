...
# (str) python-for-android specific commit to use, defaults to HEAD, must be a valid commit hash
#p4a.commit = HEAD
...
# Get a list of available identities: Xcode -> Window -> Devices and Simulators -> Select your device -> Right click -> Show Provisioning Profiles
